...
CREATE OR REPLACE FUNCTION "public"."log_access"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."log_access"() OWNER TO "postgres";
...
CREATE OR REPLACE TRIGGER "users_write_log" BEFORE INSERT OR DELETE OR UPDATE ON "public"."users" FOR EACH STATEMENT EXECUTE FUNCTION "public"."log_access"();
...
GRANT USAGE ON SCHEMA "public" TO "auth_user_1e7c7d5f_972a_4eb6_a1f0_58086a174c08";
...
GRANT SELECT ON TABLE "public"."brands" TO "auth_user_1e7c7d5f_972a_4eb6_a1f0_58086a174c08";
...
GRANT ALL ON FUNCTION "public"."log_access"() TO "anon";
GRANT ALL ON FUNCTION "public"."log_access"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."log_access"() TO "service_role";
...
GRANT SELECT ON TABLE "public"."brands_backup" TO "auth_user_1e7c7d5f_972a_4eb6_a1f0_58086a174c08";
...
GRANT SELECT ON TABLE "public"."brief_history" TO "auth_user_1e7c7d5f_972a_4eb6_a1f0_58086a174c08";
...
GRANT SELECT ON TABLE "public"."briefs" TO "auth_user_1e7c7d5f_972a_4eb6_a1f0_58086a174c08";
...
GRANT SELECT ON TABLE "public"."campaigns" TO "auth_user_1e7c7d5f_972a_4eb6_a1f0_58086a174c08";
...
GRANT SELECT ON TABLE "public"."resources" TO "auth_user_1e7c7d5f_972a_4eb6_a1f0_58086a174c08";
...
GRANT SELECT ON TABLE "public"."teams" TO "auth_user_1e7c7d5f_972a_4eb6_a1f0_58086a174c08";
